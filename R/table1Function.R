table1Function <- function (cdmDatabaseSchema, oracleTempSchema, covariateSettings,
          longTermStartDays = -365, shortTermStartDays = -3, population, connectionDetails,
          cohortTable, outputLocation)
{
